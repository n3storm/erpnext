...
def execute(filters=None):
	...
	for d in item_list:
		row = [d.item_code, d.item_name, d.item_group, d.parent, d.posting_date,
			d.party_name, d.debit_to, d.territory, d.project_name, d.company, d.sales_order,
...
def get_columns():
	return [
		...
		"Invoice:Link/Sales Invoice:120", "Posting Date:Date:80", "Customer (Party):Link/Party:120",
		"Receivable Account:Link/Account:120", "Territory:Link/Territory:80",
...
def get_items(filters):
	...
	return frappe.db.sql("""select si_item.parent, si.posting_date, si.debit_to, si.project_name,
		si.party, si.remarks, si.territory, si.company, si_item.item_code, si_item.item_name,
		si_item.item_group, si_item.sales_order, si_item.delivery_note, si_item.income_account,
		si_item.qty, si_item.base_rate, si_item.base_amount, si.party_name
