...
def execute(filters=None):
	...
	for inv in invoice_list:
		...
		row = [inv.name, inv.posting_date, inv.party, inv.party_name, inv.credit_to,
			inv.party_group, ", ".join(project_name), inv.bill_no, inv.bill_date,
...
def get_columns(invoice_list):
	...
	columns = [
		"Invoice:Link/Purchase Invoice:120", "Posting Date:Date:80", "Party:Link/Party:120",
		"Party Name::120", "Party Account:Link/Account:120",
		"Party Group:Link/Party Group:120", "Project:Link/Project:80", "Bill No::120",
...
def get_invoices(filters):
	...
	return frappe.db.sql("""select name, posting_date, credit_to, party, party_name,
