...
def execute(filters=None):
	...
	for d in item_list:
		...
		row = [d.item_code, d.item_name, d.item_group, d.parent, d.posting_date,
			d.party_name, d.credit_to, d.project_name, d.company, d.purchase_order,
...
def get_columns():
	return ["Item Code:Link/Item:120", "Item Name::120", "Item Group:Link/Item Group:100",
		"Invoice:Link/Purchase Invoice:120", "Posting Date:Date:80", "Supplier (Party):Link/Party:120",
		"Payable Account:Link/Account:120", "Project:Link/Project:80", "Company:Link/Company:100",
...
def get_items(filters):
	...
	return frappe.db.sql("""select pi_item.parent, pi.posting_date, pi.credit_to, pi.company,
		pi.party, pi.remarks, pi_item.item_code, pi_item.item_name, pi_item.item_group,
		pi_item.project_name, pi_item.purchase_order, pi_item.purchase_receipt,
		pi_item.expense_account, pi_item.qty, pi_item.base_rate, pi_item.base_amount, pi.party_name
