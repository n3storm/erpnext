...
def import_defaults():
	records = [
		...
		# party group
		{'doctype': 'Party Group', 'party_group_name': 'All Party Groups', 'is_group': 'Yes', 'name': 'All Party Groups', 'parent_party_group': ''},
		{'doctype': 'Party Group', 'party_group_name': 'Customer Groups', 'is_group': 'Yes',  'parent_party_group': 'All Party Groups'},
		{'doctype': 'Party Group', 'party_group_name': 'Individual', 'is_group': 'No', 'parent_party_group': 'Customer Groups'},
		{'doctype': 'Party Group', 'party_group_name': 'Commercial', 'is_group': 'No', 'parent_party_group': 'Customer Groups'},
		{'doctype': 'Party Group', 'party_group_name': 'Non Profit', 'is_group': 'No', 'parent_party_group': 'Customer Groups'},
		{'doctype': 'Party Group', 'party_group_name': 'Government', 'is_group': 'No', 'parent_party_group': 'Customer Groups'},

		{'doctype': 'Party Group', 'party_group_name': 'Supplier Groups', 'is_group': 'Yes',  'parent_party_group': 'All Party Groups'},
		{'doctype': 'Party Group', 'party_group_name': 'Services', 'is_group': 'No', 'parent_party_group': 'Supplier Groups'},
		{'doctype': 'Party Group', 'party_group_name': 'Local', 'is_group': 'No', 'parent_party_group': 'Supplier Groups'},
		{'doctype': 'Party Group', 'party_group_name': 'Raw Material', 'is_group': 'No', 'parent_party_group': 'Supplier Groups'},
		{'doctype': 'Party Group', 'party_group_name': 'Electrical', 'is_group': 'No', 'parent_party_group': 'Supplier Groups'},
		{'doctype': 'Party Group', 'party_group_name': 'Hardware', 'is_group': 'No', 'parent_party_group': 'Supplier Groups'},
		{'doctype': 'Party Group', 'party_group_name': 'Pharmaceutical', 'is_group': 'No', 'parent_party_group': 'Supplier Groups'},
		{'doctype': 'Party Group', 'party_group_name': 'Distributor', 'is_group': 'No', 'parent_party_group': 'Supplier Groups'},
