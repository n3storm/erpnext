...
erpnext.selling.SellingController = erpnext.TransactionController.extend({
	...
	setup_queries: function() {
		...
		$.each([["party_address", "party_filter"],
			["shipping_address_name", "party_filter"],
	...
	refresh: function() {
		this._super();
		this.frm.toggle_display("party_name",
			(this.frm.doc.party_name && this.frm.doc.party_name!==this.frm.doc.party));
	...
	party_address: function() {
		erpnext.utils.get_address_display(this.frm, "party_address");
	},
