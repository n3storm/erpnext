...
class Opportunity(TransactionBase):
	...
	def add_calendar_event(self, opts=None, force=False):
		...
		if self.party:
			if self.contact_person:
				...
				opts.description = 'Contact customer '+cstr(self.party)
		elif self.lead:
	...
	def validate_lead_cust(self):
		if self.enquiry_from == 'Lead' and not self.lead:
			frappe.throw(_("Lead is mandatory as opportunity came from a lead"))
		elif self.enquiry_from == 'Party' and not self.party:
			frappe.throw(_("Customer (Party) is mandatory as opportunity came from a party"))
